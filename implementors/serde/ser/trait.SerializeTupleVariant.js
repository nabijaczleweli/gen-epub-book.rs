...
implementors["reqwest"] = ["impl&lt;'output, Target&gt; <a class='trait' href='serde/ser/trait.SerializeTupleVariant.html' title='serde::ser::SerializeTupleVariant'>SerializeTupleVariant</a> for <a class='struct' href='serde_urlencoded/ser/struct.TupleVariantSerializer.html' title='serde_urlencoded::ser::TupleVariantSerializer'>TupleVariantSerializer</a>&lt;'output, Target&gt; <span class='where fmt-newline'>where Target: 'output + <a class='trait' href='url/form_urlencoded/trait.Target.html' title='url::form_urlencoded::Target'>Target</a></span>",];
implementors["serde"] = [];
